  ...
  return (
    <main className="sm:grid sm:place-content-center sm:h-screen sm:items-center sm:grid-flow-col sm:gap-5">
      ...
      <div className="p-5 grid gap-10 sm:grid sm:gap-5">
        ...
        <div>
          <button class="sm:w-1/2 rounded-md bg-yellow-300 px-5 py-2.5 text-gray-900 font-bold transition-all duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:-translate-y-1 active:scale-x-90 active:scale-y-110">
            Iniciar Sesión
          </button>
        </div>
        <div>
